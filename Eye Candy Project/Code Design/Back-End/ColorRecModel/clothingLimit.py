...
from torch.utils.data import Dataset # Data set class from PyTorch
from PIL import Image, ImageChops # PIL is a nice Python Image Library taht we can use to handle images
import numpy as np

## https://www.youtube.com/watch?v=V0RnRfrqMKk
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, index):   
        ...
        for i in range(num_objs):
            img = ImageChops.multiply(image_A, Image.fromarray(255*masks[i]).convert('RGB') ) #mageChops module contains a number of arithmetical image operations, called channel operations (“chops”). These can be used for various purposes, including special effects, image compositions, algorithmic painting, and more.
