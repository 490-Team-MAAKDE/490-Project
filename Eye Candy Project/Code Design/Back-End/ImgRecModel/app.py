...
# Set max size of any file making it 10MB
app.config['MAX_CONTENT_LENGTH'] = 10 * 1024 * 1024

# Files with png, jpg, and jpeg are allowed
...
# This function will load / prepare an image to right shape
def read_image(filename):
    ...
    # Imae will be reshaped
    img = img.reshape(1, 28, 28, 1)
    
    # Will be prepared as pixel data
